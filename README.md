...
The emulator requests that SDL2 is on your computer which can be acquired with a package manager known as brew.
...
Due to technical reasons and time constraints you will need to go to "Settings" in the tool bar and then "Preferences" at the bottom of the list and then "Shortcut Keys" to change some of the keybinds. below is a list of keybinds that need to be changed.
...
Once your keybinds are set up, back out of the settings and click on the "File" option at the top of the toolbar and click "Open". Once your file explorer opens, find your "Super Mario Bros.nes" file and double click it to start the game.
...
Once the code is running, it may ask for some permissions relating to controlling your keyboard. Accept them, then don't touch your mouse or the keyboard and watch as the program completes 1-1.
